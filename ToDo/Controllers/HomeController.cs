...
namespace ToDoDemo.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index(string id, Status status)
        {
            var filters = new ToDoDemo.Models.Filter(id);
            ViewBag.Privacy = filters;

            ViewBag.Categories = context.Categories.ToList();
            ViewBag.Statuses = context.Statuses.ToList();
            ViewBag.DueFilters = ToDoDemo.Models.Filter.DueFilterValues;
